...
pub mod instruction {
    ...
    pub(crate) struct Instruction {
        ...
        pub(crate) parameter_modes: Vec<ParameterMode>,
    }
...
pub mod computer {
    ...
    use std::ops::Range;
    use crate::intcode::opcode::OpCode;
    use crate::intcode::instruction::{ParameterMode, Instruction};
...
mod tests {
    use crate::intcode::computer::{Computer, RangeAddressable};
